        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a href="https://linkedin.com/in/zacharykann" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-1 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <a href="mailto:zak@zakkann.com" className="text-base text-gray-200 hover:text-white transition-colors">
                      zak@zakkann.com
                    </a>
                  </li>
                  <li>
